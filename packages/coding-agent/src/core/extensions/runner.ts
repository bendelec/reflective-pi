...
export class ExtensionRunner {
	...
	private getReflectiveContextSummarizationModelFn: () => { provider: string; model: string } | undefined = () =>
		undefined;
	...
	bindCore(
		...
		this.getReflectiveContextSummarizationModelFn = contextActions.getReflectiveContextSummarizationModel;
	...
	createContext(): ExtensionContext {
		...
		return {
			...
			getReflectiveContextSummarizationModel: () => {
				runner.assertActive();
				return runner.getReflectiveContextSummarizationModelFn();
			},
			compact: (options) => {
				runner.assertActive();
